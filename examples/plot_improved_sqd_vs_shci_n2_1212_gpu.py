...
CHEM = 1.6e-3
NPY = os.path.join(BASE, "_plot_data_sqd_vs_shci_n2_1212_gpu.npy")
...
def _plot(P):
    ...
    ax.set_title("improved SQD (GPU hybrid) vs SHCI (N2/cc-pVDZ, 12o active, 85.4e4)", fontsize=11)
    ax.legend(fontsize=8, loc="upper right")
    ax.set_xlim(900, 1e6)
    ax.set_ylim(1e-9, 0.5)
    ax.grid(True, which="both", alpha=0.3)

    out = os.path.join(BASE, "fig_improved_sqd_vs_shci_n2_1212_gpu.png")
    fig.tight_layout()
