...
CHEM = 1.6e-3
NPY = os.path.join(BASE, "_plot_data_sqd_vs_shci_n2_gpu.npy")
...
def _plot(P):
    ...
    ax.set_title("improved SQD (GPU hybrid) vs SHCI (N2/STO-3G stretch)", fontsize=12)
    ax.legend(fontsize=8, loc="upper right")
    ax.set_xlim(1000, 20000)
    ax.set_ylim(1e-10, 0.5)
    ax.grid(True, which="both", alpha=0.3)

    out = os.path.join(BASE, "fig_improved_sqd_vs_shci_n2_gpu.png")
    fig.tight_layout()
