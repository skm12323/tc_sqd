...
CHEM = 1.6e-3
NPY = os.path.join(BASE, "_plot_data_sqd_vs_shci.npy")
...
def _plot(P):
    ...
    ax.set_title("improved SQD vs SHCI (C2/STO-3G, strongly correlated)",
                 fontsize=12)
    ...
    out = os.path.join(BASE, "fig_improved_sqd_vs_shci.png")
    fig.tight_layout()
