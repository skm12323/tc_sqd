...
CHEM = 1.6e-3
NPY = os.path.join(BASE, "_plot_data_sqd_vs_shci_c2_ccpvdz_gpu.npy")
NCAS, NELEC = 10, 10
N_SEED = 3
...
def _plot(P):
    ...
    ax.set_title("improved SQD (GPU hybrid) vs SHCI (C2/cc-pVDZ, 10o active)", fontsize=12)
    ax.legend(fontsize=8, loc="upper right")
    ax.set_xlim(400, 80000)
    ax.set_ylim(1e-8, 0.5)
    ax.grid(True, which="both", alpha=0.3)

    out = os.path.join(BASE, "fig_improved_sqd_vs_shci_c2_ccpvdz_gpu.png")
    fig.tight_layout()
